                            ...
                            <div class="col-md-6">
                                ...
                                <div class="content-box-large">
                                    <div class="panel-heading">
                                        <div class="panel-title">CREAR PROVEEDOR</div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="proveedor" method="post">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="idProv" placeholder="Clave del proveedor...">                                                          
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">                                               
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="cel" placeholder="Numeero celular...">                                                          
                                            </div>
                                        </div>
                                            <div class="form-group">                                               
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="telfijo" placeholder="Telefono fijo">                                                          
                                            </div>
                                        </div>

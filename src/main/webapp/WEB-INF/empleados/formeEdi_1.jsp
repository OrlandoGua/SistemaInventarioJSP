                                ...
                                <div class="content-box-large">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="empleados" method="post">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="idEmp" value="<% if (tipoForm.equals("actualizar")) {
                                        ...
                                        <div class="form-group">                                               
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" value="<% if (tipoForm.equals("actualizar")) {

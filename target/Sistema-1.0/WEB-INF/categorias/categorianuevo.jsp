                            ...
                            <div class="col-md-6">
                                ...
                                <div class="content-box-large">
                                    <div class="panel-heading">
                                        <div class="panel-title"> <%=tipoForm %> CATEGORIA</div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="categorias" method="post">
                                            <div class="form-group"> 
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" name="idCat" placeholder="Clave de categoria..."
                                            ...
                                            <div class="form-group">                                               
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" name="nombreCat" placeholder="Nombre de categoria..."

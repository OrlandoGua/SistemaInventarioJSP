                            ...
                            <div class="col-md-6">
                                ...
                                <div class="content-box-large">
                                    <div class="panel-heading">
                                        <div class="panel-title">CREAR CLIENTE</div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="clientes" method="post">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="idCliente" placeholder="Clave del cliente...">                                                          
                                            </div>
                                        </div>

                                        <div class="form-group">                                               
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="cedula" placeholder="Cedula ruc">                                                          
                                            </div>
                                        </div>

                                        <div class="form-group">                                               
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="nombrecia" placeholder="Nombrecia...">                                                          
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">                                               
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="fijo" placeholder="Tel. Fijo...">                                                          
                                            </div>
                                        </div>
